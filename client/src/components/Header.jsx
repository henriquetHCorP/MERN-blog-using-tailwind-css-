  ...
  return (
    <Navbar className="border-b-1">
     {/* <Navbar className="bg-hcorp1 border-blue-500 border-b-1"> */}
        ...
        <Link to="/" className="items-center whitespace-nowrap text-sm sm:text-xl font-semibold dark:text-white shadow-xl shadow-black dark:shadow-slate-200 pl-3 pr-3 rounded-r-full">

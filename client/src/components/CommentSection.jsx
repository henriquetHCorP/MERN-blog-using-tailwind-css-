            ...
            <form onSubmit={handleSubmit} className="border border-blue-500 rounded-md p-3">
                ...
                <div className=" flex justify-between items-center mt-5">
                    ...
                    <Button 
                       ...
                       type='submit'
                       disabled={ comment === ""  || comment.trim() === "" || comment.includes('AFC') || comment.includes('M23') || comment.includes('Afc') || comment.includes('afc') || comment.includes('M23') || comment.includes('m23') || comment.includes('M 2 3') || comment.includes('m 2 3') || comment.includes('KAGAME') || comment.includes('Kagame') || comment.includes('kagame') || comment.includes('NANGA') || comment.includes('Nanga') || comment.includes('NANGAA') || comment.includes('Nangaa') || comment.includes('nanga') || comment.includes('Willy Ngoma') || comment.includes('VISIT RWANDA') || comment.includes('Visit Rwanda') || comment.includes('Alliance Fleuve Congo') || comment.includes('alliance fleuve congo') || comment.includes('Alliance Fleuve Congo') || comment.includes('ALLIANCE FLEUVE CONGO') || comment.includes('M-23') || comment.includes('M/23') || comment.includes('m-23') || comment.includes('m/ 2 3') || comment.includes('M/ 2 3') || comment.includes('m/23') || comment.includes('Alliance fleuve congo') || comment.includes('Alliance Fleuve congo') }
                       iconOnly
                      
                       >
                       { comment === "" || comment.trim() === "" || comment.includes('AFC') || comment.includes('M23') || comment.includes('Afc') || comment.includes('afc') || comment.includes('M23') || comment.includes('m23') || comment.includes('M 2 3') || comment.includes('m 2 3') || comment.includes('KAGAME') || comment.includes('Kagame') || comment.includes('kagame') || comment.includes('NANGA') || comment.includes('Nanga') || comment.includes('NANGAA') || comment.includes('Nangaa') || comment.includes('nanga') || comment.includes('Willy Ngoma') || comment.includes('VISIT RWANDA') || comment.includes('Visit Rwanda') || comment.includes('Alliance Fleuve Congo') || comment.includes('alliance fleuve congo') || comment.includes('Alliance Fleuve Congo') || comment.includes('ALLIANCE FLEUVE CONGO') || comment.includes('M-23') || comment.includes('M/23') || comment.includes('m-23') || comment.includes('m/ 2 3') || comment.includes('M/ 2 3') || comment.includes('m/23') || comment.includes('Alliance fleuve congo') || comment.includes('Alliance Fleuve congo')? <BsSend color="gray" className='h-5 w-5' /> : <BsFillSendFill color="blue" className='h-5 w-5' />}
